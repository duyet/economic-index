...
export default function USPage() {
  ...
  if (isError || !states) {
    return <div className="p-8">Error loading states data</div>;
  }

  // Calculate top states by usage
  const topStates = [...states]
    .filter((s) => s.metrics.usage_per_capita_index)
    .sort((a, b) => (b.metrics.usage_per_capita_index || 0) - (a.metrics.usage_per_capita_index || 0))
    .slice(0, 10);
                ...
                {topStates.map((state, index) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-right font-mono">
                      {formatIndex(state.metrics.usage_per_capita_index || 0)}
                    </td>
                    <td className="py-3 px-4 text-right font-mono">
