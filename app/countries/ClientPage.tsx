...
export default function CountriesPage() {
  ...
  if (isError || !countries) {
    return (
      <MainLayout>
        <div className="p-8">Error loading countries data</div>
      </MainLayout>
    );
  }
  ...
  return (
    <MainLayout>
      <div className="max-w-6xl">
        ...
        {/* Controls */}
        <div className="flex gap-4 mb-6" role="search" aria-label="Search and sort countries">
        ...
        {/* Countries Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4" role="list" aria-label="Country list">
        ...
        {filteredCountries.length === 0 && (
          <div className="text-center py-12 text-gray-500">
            No countries found matching &quot;{escapeHtml(sanitizedSearchTerm)}&quot;
          </div>
        )}
      </div>
    </MainLayout>
